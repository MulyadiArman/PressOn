...
class ForgotPasswordActivity : AppCompatActivity() {
    ...
    private fun forgotPassToServer(email: String) {
        ...
        ApiServices.getLiveAttendanceServices()
            ...
            .enqueue(object : retrofit2.Callback<ForgotPasswordResponse> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful){
                        ...
                        MyDialog(dynamicDialog(this@ForgotPasswordActivity, getString(R.string.success),message.toString()))
